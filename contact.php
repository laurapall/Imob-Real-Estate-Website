        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">Hai să vorbim!</h1>
              <span class="color-text-a">Tu ești responsabil să iei cea mai bună decizie pentru tine și familia ta, iar noi suntem aici să facem decizia ta să fie cea mai bună. Află toate detaliile despre viitoarea ta casă. Echipa noastră îți stă la dispoziție.</span>
            </div>
          </div>
            ...
            <div class="row">
                ...
                <form action="forms/contact.php" method="post">
                  <div class="row">
                    <div class="col-md-6 mb-3">
                      <div class="form-group">
                        <input type="text" name="name" class="form-control form-control-lg form-control-a" placeholder="Numele Dvs." required>
                      </div>
                    </div>
                    <div class="col-md-6 mb-3">
                      <div class="form-group">
                        <input name="email" type="email" class="form-control form-control-lg form-control-a" placeholder="Adresa de email" required>
                      </div>
                    </div>
                    <div class="col-md-12 mb-3">
                      <div class="form-group">
                        <input type="text" name="subject" class="form-control form-control-lg form-control-a" placeholder="Subiect" required>
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        <textarea name="message" class="form-control" name="message" cols="45" rows="8" placeholder="Mesaj" required></textarea>
                      </div>
                    </div>
                

                    <div class="col-md-12 text-center">
                      <button type="submit" class="btn btn-a">Trimite mesaj</button>
                    </div>
                  </div>
                </form>
              </div>
              <div class="col-md-5 section-md-t3">
                <div class="icon-box section-b2">
                  ...
                  <div class="icon-box-content table-cell">
                    <div class="icon-box-title">
                      <h4 class="icon-title">Contactați-ne!</h4>
                    </div>
                    <div class="icon-box-content">
                      <p class="mb-1">Email.
                        <span class="color-a">contact@imob.ro</span>
                      </p>
                      <p class="mb-1">Phone.
                        <span class="color-a">+40264 500 300</span>
                      </p>
                    </div>
                  </div>
                </div>
                <div class="icon-box section-b2">
                  ...
                  <div class="icon-box-content table-cell">
                    <div class="icon-box-title">
                      <h4 class="icon-title">Ne puteți găsi la</h4>
                    </div>
                    <div class="icon-box-content">
                      <p class="mb-1">
                        Cluj-Napoca, CJ 452220,
                        <br> România
                      </p>
                    </div>
                  </div>
