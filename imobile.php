        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">Proprietăți listate</h1>
              <span class="color-text-a">Toate imobilele</span>
            </div>
          </div>
                ...
                <div class="card-overlay-a-content">
                  ...
                  <div class="card-body-a">
                    <div class="price-box d-flex">
                      <span class="price-a"><?= $rezte['statut'] ?> | <?= $rezte['pret'] ?></span>
                    </div>
                  ...
                  <div class="card-footer-a">
                    <ul class="card-info d-flex justify-content-around">
                      ...
                      <li>
                        ...
                        <span><?= $rezte['nr_camere'] ?></span>
                      </li>
                      <li>
                        <h4 class="card-info-title">Baie</h4>
                        <span><?= $rezte['nr_baie'] ?></span>
                      </li>
                      <li>
                        <h4 class="card-info-title">Garaj</h4>
                        <span><?= $rezte['nr_garaj'] ?></span>
                      </li>
                    </ul>
                  </div>
                </div>
