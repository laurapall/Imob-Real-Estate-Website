  ...
  <main id="main">
        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">Agenții noștri</h1>
              <span class="color-text-a">Agenția imobiliară IMOB</span>
            </div>          
          </div>
    ...
    <section class="agents-grid grid">
      <div class="container">
        ...
        <?php
 $interogareagent = "SELECT cod_agent, nume, prenume, imagine, abilitate, telefon, mobil, email, skype, twitter, facebook, linkedin, instagram from agenti";
 //  Execut comanda SQL
 $trimitagent = mysqli_query($cnx, $interogareagent) or die("Eroare: " . mysqli_error($cnx));
 while($rezag = mysqli_fetch_assoc($trimitagent)) :?>


          <div class="col-md-4">
            <div class="card-box-d">
              <div class="card-img-d">
                <img src="assets/img/<?= $rezag['imagine'] ?>" alt="" class="img-d img-fluid">
              </div>
              <div class="card-overlay card-overlay-hover">
                <div class="card-header-d">
                  <div class="card-title-d align-self-center">
                    <h3 class="title-d">
                      <a href="detalii.php?codagent=<?= $rezag['cod_agent'] ?>" class="link-two"><?= $rezag['prenume'].' '. $rezag['nume'] ?></a>
                    </h3>
                  </div>
                </div>
                <div class="card-body-d">
                  ...
                  <div class="info-agents color-a">
                    <p>
                      <strong>Telefon: </strong> <?= $rezag['telefon'] ?>
                    </p>
                    <p>
                      <strong>Email: </strong> <?= $rezag['email'] ?>
                    </p>
                  </div>
                </div>
                    ...
                    <ul class="list-inline">
                      <li class="list-inline-item">
                        <a href="#" class="link-one">
                          <i class="<?= $rezag['facebook'] ?>" aria-hidden="true"></i>
                        </a>
                      </li>
                      <li class="list-inline-item">
                        <a href="#" class="link-one">
                          <i class="<?= $rezag['twitter'] ?>" aria-hidden="true"></i>
                        </a>
                      </li>
                      <li class="list-inline-item">
                        <a href="#" class="link-one">
                          <i class="<?= $rezag['instagram'] ?>" aria-hidden="true"></i>
                        </a>
                      </li>
                      <li class="list-inline-item">
                        <a href="#" class="link-one">
                          <i class="<?= $rezag['linkedin'] ?>" aria-hidden="true"></i>
                        </a>
                      </li>
                    </ul>
                  </div>
